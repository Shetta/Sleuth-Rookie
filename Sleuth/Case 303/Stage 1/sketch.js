...
Officer: 4378685
CaseNum: 303-0-62510453-4378685
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make HiddenSafeCode0 equal to 13

	When any key is released:
	- Make HiddenSafeCode0 equal to 26

	Whilst the mouse is being dragged:
	- Make HiddenSafeCode0 equal to 2

	When the mouse button is released:
	- Make HiddenSafeCode0 equal to 40

	When any key is pressed:
	- Make HiddenSafeCode1 equal to 43

	When any key is released:
	- Make HiddenSafeCode1 equal to 46

	When the mouse button is released:
	- Make HiddenSafeCode1 equal to 18

	Whilst the mouse is moving:
	- Make HiddenSafeCode1 equal to 6
...
function draw()
{
	...
	drawDial(200, HiddenSafeCode0, 51);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(HiddenSafeCode1);
	pop();
